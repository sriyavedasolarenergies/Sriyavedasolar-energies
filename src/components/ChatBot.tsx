...
const ChatBot = () => {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-80 sm:w-96 bg-gradient-to-br from-gray-900 to-black rounded-2xl shadow-2xl border border-orange-500/20 z-50 flex flex-col animate-in slide-in-from-bottom-5 duration-300">
          {/* Header */}
